            ...
            <div class="row classes-items text-center">
                        ...
                        <div class="top-content">
                            ...
                            <div class="hover-content">
                                <div class="btn-wrapper desktop-center">
                                    <a href="#" class="btn btn-element btn-normal-size btn-rounded">Details</a>
                                </div>
                            </div>
                        </div>
                        <div class="bottom-content">
                            <h3><a href="class-details.html">Yoga Class 01</a></h3>
                            <p>Praesent a diam at velit finibus vehicula sit amet eu dui. Vestibulum rutrum dignissim
                                arcu, vitae convallis libero. Nulla interdum erat</p>
                            <h4>Course Price : $120</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="single-class-item">
                        ...
                        <div class="bottom-content">
                            <h3><a href="class-details.html">Yoga Class 02</a></h3>
                            <p>Praesent a diam at velit finibus vehicula sit amet eu dui. Vestibulum rutrum dignissim
                                arcu, vitae convallis libero. Nulla interdum erat</p>
                            <h4>Course Price : $80</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="single-class-item">
                        ...
                        <div class="bottom-content">
                            <h3><a href="class-details.html">Gym Class 01</a></h3>
                            <p>Praesent a diam at velit finibus vehicula sit amet eu dui. Vestibulum rutrum dignissim
                                arcu, vitae convallis libero. Nulla interdum erat</p>
                            <h4>Course Price : $180</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="single-class-item">
                        ...
                        <div class="bottom-content">
                            <h3><a href="class-details.html">Gym Class 02</a></h3>
                            <p>Praesent a diam at velit finibus vehicula sit amet eu dui. Vestibulum rutrum dignissim
                                arcu, vitae convallis libero. Nulla interdum erat</p>
                            <h4>Course Price : $320</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="single-class-item">
                        ...
                        <div class="bottom-content">
                            <h3><a href="class-details.html">Fitness Class 01</a></h3>
                            <p>Praesent a diam at velit finibus vehicula sit amet eu dui. Vestibulum rutrum dignissim
                                arcu, vitae convallis libero. Nulla interdum erat</p>
                            <h4>Course Price : $60</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="single-class-item">
                        ...
                        <div class="bottom-content">
                            <h3><a href="class-details.html">Fitness Class 02</a></h3>
                            <p>Praesent a diam at velit finibus vehicula sit amet eu dui. Vestibulum rutrum dignissim
                                arcu, vitae convallis libero. Nulla interdum erat</p>
                            <h4>Course Price : $420</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="single-class-item">
                        ...
                        <div class="bottom-content">
                            <h3><a href="class-details.html">Body Class 01</a></h3>
                            <p>Praesent a diam at velit finibus vehicula sit amet eu dui. Vestibulum rutrum dignissim
                                arcu, vitae convallis libero. Nulla interdum erat</p>
                            <h4>Course Price : $320</h4>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="single-class-item">
                        ...
                        <div class="bottom-content">
                            <h3><a href="class-details.html">Body Class 02</a></h3>
                            <p>Praesent a diam at velit finibus vehicula sit amet eu dui. Vestibulum rutrum dignissim
                                arcu, vitae convallis libero. Nulla interdum erat</p>
                            <h4>Course Price : $220</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="single-class-item">
                        ...
                        <div class="bottom-content">
                            <h3><a href="class-details.html">Body Class 03</a></h3>
                            <p>Praesent a diam at velit finibus vehicula sit amet eu dui. Vestibulum rutrum dignissim
                                arcu, vitae convallis libero. Nulla interdum erat</p>
                            <h4>Course Price : $820</h4>
                        </div>
                    </div>
                </div>
            </div>
