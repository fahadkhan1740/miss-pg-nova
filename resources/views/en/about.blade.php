<x-en-master>
    ...
    <div class="breadcrumb-style-1 about-breadcrumb-overlay"
         style="background-image:url({{ 'storage/'.getBanner('about-us') }});">
            ...
            <div class="row row-eq-height">
                ...
                <div class="col-lg-7 px-md-5">
                    <h2 class="display-6 about-box-underline">
                        Al NAWADI HOLDING’s <br>
                        HISTORY & VISION
                    </h2>
                    <div class="card-text">
                        {!! $aboutUs->history_vision_en !!}
                    </div>
                </div>
        ...
        <div class="container padding-top-50 padding-bottom-50">
            <div class="row ">
                <div class="col-lg-12">
                    ...
                    <div class="text-center">{!! $aboutUs->mission_en !!}</div>
                </div>
        ...
        <div class="container">
            <div class="row ">
                <div class="col-lg-12">
                    ...
                    <div class="text-center">{!! $aboutUs->core_values_en !!}</div>
                </div>
