                ...
                @for ($j=1;$j<=4;$j++) <div class="col-lg-3">
                    <div class="card">
                        ...
                        <div class="card-body pl-0">
                            ...
                            <p class="card-text">Culpa enim tempor elit fugiat ex reprehenderit. Id excepteur laborum
                                quis
                                Lorem exercitation ut mollit dolor culpa dolore commodo. Sunt aliquip adipisicing
                                cupidatat
                            </p>
                        </div>
                    </div>
